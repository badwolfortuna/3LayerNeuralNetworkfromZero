-Neural net firsttry.py dosyasının içerisindedir
-YeniTest.py mnist datasetindeki karşılastırmaları görmek için yazılan sinir ağının test dosyasıdır 
...
3 hidden layer ,Handwritten Image Classification Neural Net.
